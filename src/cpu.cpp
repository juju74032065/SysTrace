...
namespace procmon
{
    ...
    // It represents one tick of the system timer. The duration of a jiffy depends on the kernel setting,
    // typically 1/100, 1/250, or 1/1000 of a second (e.g., 1 jiffy = 1 ms if the system uses 1000 Hz).
    ...
    float GetCPUUsage()
    {
        ...
        return 100.0f * (1.0f - idleDelta / totalDelta);
    }
